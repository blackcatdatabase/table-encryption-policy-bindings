...
namespace BlackCat\Database\Packages\EncryptionPolicyBindings;
...
use BlackCat\Database\Packages\EncryptionPolicyBindings\Repository\EncryptionPolicyBindingRepository as GeneratedRepository;
...
{
  private EncryptionPolicyBindingRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof EncryptionPolicyBindingRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected EncryptionPolicyBindingRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\EncryptionPolicyBindings\Dto\EncryptionPolicyBindingDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\EncryptionPolicyBindings\Dto\EncryptionPolicyBindingDto|null { return $this->repo->getById($id, $asDto); }

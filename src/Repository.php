...
use BlackCat\Database\Packages\EncryptionPolicyBindings\Repository\EncryptionPolicyBindingRepository;
...
{
    private EncryptionPolicyBindingRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new EncryptionPolicyBindingRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\EncryptionPolicyBindings\Dto\EncryptionPolicyBindingDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\EncryptionPolicyBindings\Dto\EncryptionPolicyBindingDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\EncryptionPolicyBindings\Dto\EncryptionPolicyBindingDto|null
    {

...
final class EncryptionPolicyBindingsModule implements ModuleInterface
{
    public function name(): string { return 'table-encryption_policy_bindings'; }
    public function table(): string { return 'encryption_policy_bindings'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-encryption_policies' ]; }

    public static function contractView(): string { return 'vw_encryption_policy_bindings'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_enc_pol_bind_entity' ];
        if ($d->isMysql()) {
        ...
        $expectedFk  = [ 'fk_enc_pol_bind_policy' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_enc_pol_bind_entity' ],
            'foreignKeys' => [ 'fk_enc_pol_bind_policy' ],
        ];
    }
}

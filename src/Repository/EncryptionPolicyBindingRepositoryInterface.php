...
/**
 * Contract generated for EncryptionPolicyBinding repositories.
 * Mirrors the public API of the generated repository so tests can type against the interface.
 */
interface EncryptionPolicyBindingRepositoryInterface extends RepoContract, KeysetRepoContract
{
    // --- INSERT / BULK -------------------------------------------------------

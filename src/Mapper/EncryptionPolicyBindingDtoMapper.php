...
namespace BlackCat\Database\Packages\EncryptionPolicyBindings\Mapper;

use BlackCat\Database\Packages\EncryptionPolicyBindings\Dto\EncryptionPolicyBindingDto;
use BlackCat\Database\Packages\EncryptionPolicyBindings\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO EncryptionPolicyBindingDto:
...
final class EncryptionPolicyBindingDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'id' => 'id', 'entity_table' => 'entityTable', 'field_name' => 'fieldName', 'policy_id' => 'policyId', 'effective_from' => 'effectiveFrom', 'notes' => 'notes' ];
     ...
     * @return EncryptionPolicyBindingDto
     */
    public static function fromRow(array $row): EncryptionPolicyBindingDto
    {
        /** @var EncryptionPolicyBindingDto */
        return DtoHydrator::fromRow(
            EncryptionPolicyBindingDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?EncryptionPolicyBindingDto
    {
     ...
     *
     * @param EncryptionPolicyBindingDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(EncryptionPolicyBindingDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(EncryptionPolicyBindingDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(EncryptionPolicyBindingDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,EncryptionPolicyBindingDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,EncryptionPolicyBindingDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(EncryptionPolicyBindingDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,EncryptionPolicyBindingDto>
     */

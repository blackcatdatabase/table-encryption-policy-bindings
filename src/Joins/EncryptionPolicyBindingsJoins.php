...
namespace BlackCat\Database\Packages\EncryptionPolicyBindings\Joins;
 ...
 */
final class EncryptionPolicyBindingsJoins {
    ...
    /**
     * FK: encryption_policy_bindings -> encryption_policies

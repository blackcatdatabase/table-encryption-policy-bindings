...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'entity_table', 'field_name', 'policy_id', 'effective_from', 'notes' ];
    }
    ...
    {
        $x = [ 'id', 'entity_table', 'field_name', 'policy_id', 'effective_from', 'notes' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\EncryptionPolicyBindings\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\EncryptionPolicyBindings\Definitions::softDeleteColumn();

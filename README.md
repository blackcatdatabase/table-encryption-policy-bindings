...
| Pkg folder | [packages/encryption-policy-bindings](https://github.com/blackcatacademy/blackcat-database/blob/main/packages/encryption-policy-bindings) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package encryption-policy-bindings -Apply

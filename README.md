...
- Pkg folder: [packages\encryption-policy-bindings](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\encryption-policy-bindings)
...
graph LR
  ...
  encryption_policy_bindings["encryption_policy_bindings"]:::center
  encryption_policy_bindings -->|FK| encryption_policies["encryption_policies"]:::link
...
- Outbound (depends on): "encryption_policies"
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package encryption-policy-bindings -Apply
